...
mkdir -p output_visual/ tmp/ output_collision/
...
meshlabserver -i tmp/0.stl -o output_collision/link_3_u.stl -s ../meshlab_03_no_offset_300t.mlx
...
#meshlabserver -i tmp/0.stl -o tmp/1.stl -s ../meshlab_02_invert_faces.mlx
meshlabserver -i tmp/0.stl -o output_collision/link_4_r.stl -s ../meshlab_03_no_offset_300t.mlx
...
meshlabserver -i tmp/0.stl -o output_collision/link_6_t.stl -s ../meshlab_03_no_offset_300t.mlx
