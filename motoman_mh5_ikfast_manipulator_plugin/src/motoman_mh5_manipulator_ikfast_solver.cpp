...
///
/// ikfast version 0x10000049 generated on 2017-06-17 23:28:17.109363
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
x40=(x20*(((((-1.0)*x26))+(((-1.0)*x25)))));
x41=(x37*x6);
x42=(x40*x8);
x43=((((-1.0)*x20*x5))+((x36*x6)));
x44=(((x0*x5))+x41);
x45=((((-1.0)*x20*x6))+((x5*(((((-1.0)*x21*x22))+x29)))));
x46=(((x0*x6))+((x5*((x30+(((-1.0)*x20*x22)))))));
eerot[0]=(((x9*((((x0*x25))+((x2*x23))))))+((x43*x8)));
eerot[1]=(((x11*x45))+((x10*(((((-1.0)*x17*x43))+(((-1.0)*x15*x39)))))));
eerot[2]=(((x11*((((x39*x8))+((x43*x9))))))+((x10*x45)));
eetrans[0]=(((x8*(((((-1.0)*x16*x5))+((x14*x36))))))+((x0*x18))+(((-1.0)*x12*x23))+(((0.088)*x0))+((x9*((((x19*x25))+((x19*x26))))))+((x0*x1*x13))+(((0.0399)*x0*x22))+(((0.305)*x2*x23)));
eerot[3]=(((x9*((((x26*x7))+((x25*x7))))))+((x44*x8)));
eerot[4]=(((x10*(((((-1.0)*x15*x40))+(((-1.0)*x17*x44))))))+((x11*x46)));
eerot[5]=(((x10*x46))+((x11*((x42+((x44*x9)))))));
eetrans[1]=(((x18*x7))+(((0.305)*x26*x7))+((x8*((((x19*x5))+((x14*x37))))))+(((0.088)*x7))+((x1*x13*x7))+(((0.0399)*x22*x7))+(((-1.0)*x12*x4*x7))+((x9*((((x16*x26))+((x16*x25)))))));
eerot[6]=(((x9*(((((-1.0)*x28))+x27))))+((x24*x31)));
eerot[7]=(((x10*(((((-1.0)*x17*x34))+(((-1.0)*x15*x32))))))+((x11*x38)));
eerot[8]=(((x10*x38))+((x11*((((x34*x9))+x35)))));
eetrans[2]=((0.33)+((x1*x12))+((x24*(((((0.0865)*x26))+(((0.0865)*x25))))))+(((0.31)*x3))+(((0.0399)*x26))+((x9*(((((-0.0865)*x22))+(((0.0865)*x27))))))+((x13*x4))+(((-0.305)*x22)));
}
...
new_r01=r01;
new_r02=((-1.0)*r00);
new_px=((((-0.0865)*r00))+px);
new_r10=r12;
new_r11=r11;
new_r12=((-1.0)*r10);
new_py=((((-0.0865)*r10))+py);
new_r20=r22;
new_r21=r21;
new_r22=((-1.0)*r20);
new_pz=((-0.33)+(((-0.0865)*r20))+pz);
...
_nj2 = 2;
if( (((0.959424342380189)+(((0.922861160008863)*py*sj0))+(((0.922861160008863)*cj0*px))+(((-5.24352931823217)*pp)))) < -1-IKFAST_SINCOS_THRESH || (((0.959424342380189)+(((0.922861160008863)*py*sj0))+(((0.922861160008863)*cj0*px))+(((-5.24352931823217)*pp)))) > 1+IKFAST_SINCOS_THRESH )
    continue;
IkReal x52=IKasin(((0.959424342380189)+(((0.922861160008863)*py*sj0))+(((0.922861160008863)*cj0*px))+(((-5.24352931823217)*pp))));
j2array[0]=((-0.130080969307385)+(((-1.0)*x52)));
sj2array[0]=IKsin(j2array[0]);
cj2array[0]=IKcos(j2array[0]);
j2array[1]=((3.01151168428241)+x52);
...
IkReal x54=(cj2*sj2);
IkReal x55=(py*sj0);
IkReal x56=((86.8648894964685)*cj2);
IkReal x57=(cj0*px);
IkReal x58=((11.3636363636364)*sj2);
IkReal x59=(pz*sj2);
IkReal x60=((0.0399)*sj2);
IkReal x61=((0.305)*cj2);
IkReal x62=(cj2*pz);
j1eval[0]=((((-1.0)*x56*x57))+(((7.64411027568922)*cj2))+(((-1.0)*sj2))+(((11.3636363636364)*x62))+(((-1.0)*x55*x56))+(((86.8648894964685)*x59))+((x57*x58))+(((88.2889040783778)*pz))+((x55*x58)));
j1eval[1]=IKsign(((((0.305)*x59))+(((-0.0035112)*sj2))+(((0.02684)*cj2))+(((-1.0)*x55*x61))+((x57*x60))+(((0.31)*pz))+(((-1.0)*x57*x61))+(((0.0399)*x62))+((x55*x60))));
j1eval[2]=((IKabs(((0.0121695)+(((-0.088)*pz))+(((-0.09143299)*x54))+(((0.012369)*sj2))+(((-0.024339)*x53))+(((-0.09455)*cj2))+((pz*x57))+((pz*x55)))))+(IKabs(((-0.00159201)+(((-0.09143299)*x53))+(pz*pz)+(((0.024339)*x54))))));
if( IKabs(j1eval[0]) < 0.0000010000000000  || IKabs(j1eval[1]) < 0.0000010000000000  || IKabs(j1eval[2]) < 0.0000010000000000  )
{
{
IkReal j1eval[2];
IkReal x63=(py*sj0);
IkReal x64=((86.8648894964685)*sj2);
IkReal x65=((0.0399)*cj2);
IkReal x66=(pz*sj2);
IkReal x67=(cj0*px);
IkReal x68=((11.3636363636364)*cj2);
IkReal x69=(cj2*pz);
IkReal x70=((0.305)*sj2);
j1eval[0]=((7.76942355889724)+(((-88.2889040783778)*x63))+(((-88.2889040783778)*x67))+(((11.3636363636364)*x66))+cj2+(((-1.0)*x67*x68))+(((-86.8648894964685)*x69))+(((-1.0)*x64*x67))+(((7.64411027568922)*sj2))+(((-1.0)*x63*x68))+(((-1.0)*x63*x64)));
j1eval[1]=IKsign(((0.02728)+(((-0.305)*x69))+(((-0.31)*x67))+(((-0.31)*x63))+(((-1.0)*x63*x70))+(((0.0035112)*cj2))+(((-1.0)*x67*x70))+(((-1.0)*x65*x67))+(((-1.0)*x63*x65))+(((0.02684)*sj2))+(((0.0399)*x66))));
...
IkReal x77=(x71*x72);
IkReal x78=(x72*x73);
j1eval[0]=((-1.0)+(((-129.132231404959)*x78))+(((-129.132231404959)*x71))+(((-129.132231404959)*x74))+(((129.132231404959)*x77))+(((-258.264462809917)*x75*x76))+(((22.7272727272727)*x75))+(((22.7272727272727)*x76)));
j1eval[1]=IKsign(((-0.007744)+(((0.176)*x75))+(((0.176)*x76))+(((-2.0)*x75*x76))+x77+(((-1.0)*x78))+(((-1.0)*x74))+(((-1.0)*x71))));
if( IKabs(j1eval[0]) < 0.0000010000000000  || IKabs(j1eval[1]) < 0.0000010000000000  )
{
...
IkReal x81=(cj0*px);
IkReal x82=(py*sj0);
IkReal x83=((0.0399)*cj2);
IkReal x84=((0.0399)*sj2);
IkReal x85=((0.305)*cj2);
IkReal x86=((0.305)*sj2);
CheckValue<IkReal> x87 = IKatan2WithCheck(IkReal(((0.02728)+(((-1.0)*x81*x83))+(((-1.0)*x81*x86))+(((-1.0)*x82*x83))+(((-1.0)*x82*x86))+((pz*x85))+(((-0.31)*x82))+(((-0.31)*x81))+(((0.0035112)*cj2))+(((0.02684)*sj2))+(((-1.0)*pz*x84)))),IkReal(((((-1.0)*x81*x85))+(((-1.0)*x82*x85))+(((-0.31)*pz))+(((-0.0035112)*sj2))+(((0.02684)*cj2))+((x82*x84))+((x81*x84))+(((-1.0)*pz*x86))+(((-1.0)*pz*x83)))),IKFAST_ATAN2_MAGTHRESH);
if(!x87.valid){
continue;
}
CheckValue<IkReal> x88=IKPowWithIntegerCheck(IKsign(((-0.007744)+((x79*x80))+(((-1.0)*x80*(px*px)))+(((0.176)*x82))+(((0.176)*x81))+(((-2.0)*x81*x82))+(((-1.0)*(pz*pz)))+(((-1.0)*x79)))),-1);
if(!x88.valid){
continue;
}
...
IkReal x91=(cj0*px);
IkReal x92=(py*sj0);
IkReal x93=((0.305)*cj2);
IkReal x94=((0.0399)*sj2);
IkReal x95=((0.0399)*cj2);
IkReal x96=((0.305)*sj2);
IkReal x97=((1.0)*x90);
IkReal x98=((1.0)*x89);
IkReal x99=((0.62)*x90);
evalcond[0]=((((-1.0)*x91*x98))+((pz*x90))+x93+(((-1.0)*x92*x98))+(((0.088)*x89))+(((-1.0)*x94)));
evalcond[1]=((((-1.0)*x90*x94))+(((-0.31)*x89))+((x90*x93))+pz+(((-1.0)*x89*x95))+(((-1.0)*x89*x96)));
evalcond[2]=((0.31)+(((-1.0)*pz*x98))+(((-1.0)*x91*x97))+x95+x96+(((-1.0)*x92*x97))+(((0.088)*x90)));
evalcond[3]=((-0.00922699)+((x92*x99))+(((0.176)*x92))+(((0.176)*x91))+(((-1.0)*pp))+(((0.62)*pz*x89))+(((-0.05456)*x90))+((x91*x99)));
evalcond[4]=((0.088)+((x89*x93))+(((0.31)*x90))+((x90*x95))+((x90*x96))+(((-1.0)*x92))+(((-1.0)*x91))+(((-1.0)*x89*x94)));
...
IkReal x1521=(cj0*px);
IkReal x1522=((1.0)*pz);
IkReal x1523=((0.0399)*cj2);
IkReal x1524=(py*sj0);
IkReal x1525=((0.305)*sj2);
CheckValue<IkReal> x1526 = IKatan2WithCheck(IkReal(((-0.189125)+(((0.09143299)*x1519))+(((-0.024738)*cj2))+(((-0.024339)*x1520))+(pz*pz)+(((-0.1891)*sj2)))),IkReal(((0.0121695)+(((-0.024339)*x1519))+(((0.012369)*sj2))+(((-1.0)*x1522*x1524))+(((-0.09455)*cj2))+(((-0.09143299)*x1520))+(((-1.0)*x1521*x1522))+(((0.088)*pz)))),IKFAST_ATAN2_MAGTHRESH);
if(!x1526.valid){
continue;
}
CheckValue<IkReal> x1527=IKPowWithIntegerCheck(IKsign(((0.02728)+(((-1.0)*x1524*x1525))+(((-0.31)*x1524))+(((-0.31)*x1521))+(((0.0399)*pz*sj2))+(((0.0035112)*cj2))+(((-1.0)*x1523*x1524))+(((-0.305)*cj2*pz))+(((0.02684)*sj2))+(((-1.0)*x1521*x1523))+(((-1.0)*x1521*x1525)))),-1);
if(!x1527.valid){
continue;
}
...
IkReal x1530=(cj0*px);
IkReal x1531=(py*sj0);
IkReal x1532=((0.305)*cj2);
IkReal x1533=((0.0399)*sj2);
IkReal x1534=((0.0399)*cj2);
IkReal x1535=((0.305)*sj2);
IkReal x1536=((1.0)*x1529);
IkReal x1537=((1.0)*x1528);
IkReal x1538=((0.62)*x1529);
evalcond[0]=((((-1.0)*x1530*x1537))+(((-1.0)*x1531*x1537))+(((-1.0)*x1533))+x1532+((pz*x1529))+(((0.088)*x1528)));
evalcond[1]=((((-1.0)*x1529*x1533))+(((-0.31)*x1528))+((x1529*x1532))+pz+(((-1.0)*x1528*x1534))+(((-1.0)*x1528*x1535)));
evalcond[2]=((0.31)+(((-1.0)*x1530*x1536))+(((-1.0)*x1531*x1536))+x1535+x1534+(((0.088)*x1529))+(((-1.0)*pz*x1537)));
evalcond[3]=((-0.00922699)+(((0.176)*x1530))+(((0.176)*x1531))+((x1531*x1538))+((x1530*x1538))+(((-1.0)*pp))+(((0.62)*pz*x1528))+(((-0.05456)*x1529)));
evalcond[4]=((0.088)+(((-1.0)*x1531))+(((-1.0)*x1530))+((x1528*x1532))+((x1529*x1535))+((x1529*x1534))+(((-1.0)*x1528*x1533))+(((0.31)*x1529)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1541=(py*sj0);
IkReal x1542=(cj0*px);
IkReal x1543=((0.305)*cj2);
IkReal x1544=((0.0399)*sj2);
CheckValue<IkReal> x1545 = IKatan2WithCheck(IkReal(((0.0121695)+(((-0.088)*pz))+(((0.012369)*sj2))+(((-0.024339)*x1539))+(((-0.09143299)*x1540))+(((-0.09455)*cj2))+((pz*x1541))+((pz*x1542)))),IkReal(((-0.00159201)+(pz*pz)+(((0.024339)*x1540))+(((-0.09143299)*x1539)))),IKFAST_ATAN2_MAGTHRESH);
if(!x1545.valid){
continue;
}
CheckValue<IkReal> x1546=IKPowWithIntegerCheck(IKsign(((((0.0399)*cj2*pz))+(((-0.0035112)*sj2))+(((0.02684)*cj2))+((x1541*x1544))+(((0.31)*pz))+(((0.305)*pz*sj2))+(((-1.0)*x1542*x1543))+((x1542*x1544))+(((-1.0)*x1541*x1543)))),-1);
if(!x1546.valid){
continue;
}
...
IkReal x1549=(cj0*px);
IkReal x1550=(py*sj0);
IkReal x1551=((0.305)*cj2);
IkReal x1552=((0.0399)*sj2);
IkReal x1553=((0.0399)*cj2);
IkReal x1554=((0.305)*sj2);
IkReal x1555=((1.0)*x1548);
IkReal x1556=((1.0)*x1547);
IkReal x1557=((0.62)*x1548);
evalcond[0]=((((-1.0)*x1549*x1556))+x1551+(((0.088)*x1547))+(((-1.0)*x1550*x1556))+(((-1.0)*x1552))+((pz*x1548)));
evalcond[1]=((((-1.0)*x1548*x1552))+pz+(((-0.31)*x1547))+((x1548*x1551))+(((-1.0)*x1547*x1553))+(((-1.0)*x1547*x1554)));
evalcond[2]=((0.31)+(((-1.0)*pz*x1556))+(((-1.0)*x1549*x1555))+x1553+x1554+(((0.088)*x1548))+(((-1.0)*x1550*x1555)));
evalcond[3]=((-0.00922699)+(((-0.05456)*x1548))+((x1550*x1557))+(((-1.0)*pp))+((x1549*x1557))+(((0.176)*x1549))+(((0.62)*pz*x1547))+(((0.176)*x1550)));
evalcond[4]=((0.088)+(((-1.0)*x1549))+(((-1.0)*x1550))+((x1547*x1551))+(((0.31)*x1548))+((x1548*x1554))+((x1548*x1553))+(((-1.0)*x1547*x1552)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - motoman_mh5 (5ef7f7ae6ae59184105d9be826f66357)>"; }
