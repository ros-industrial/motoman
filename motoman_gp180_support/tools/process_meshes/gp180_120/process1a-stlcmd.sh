...
stl_transform -rx 90 -rz 180 -s 0.001 -tx -1.915 -tz -2.1 input/R_AXIS.stl output_visual/link_4_r.stl
stl_transform -rx 90 -rz 180 -s 0.001 -tx -1.915 -tz -2.1 input/B_AXIS.stl output_visual/link_5_b.stl
stl_transform -rx 90 -rz 180 -s 0.001 -tx -1.915 -tz -2.1 input/T_AXIS.stl output_visual/link_6_t.stl
